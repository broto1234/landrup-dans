  ...
  return (
    <section className="">
      <form action={formAction} noValidate className="flex flex-col space-y-2">                
        ...
        <p className="text-xs mt-2">Are You not yet a Member? <Link href="/register" className="underline underline-offset-3">Sign up here</Link> to start training like a pro. </p>
      </form>
    </section>
  );
}